...
import HW7.SurvivalModelClasses as SurvivalCls
...
class Calibration:
    ...
    def sample_posterior(self):
        ...
        for cohort_id in self._cohortIDs:
            ...
            # get the proportion of patients who survived beyond 5 years
            prob = multiCohort.get_cohort_prob_five_year_survival(cohort_id)

            # construct a binomial distribution for the likelihood
