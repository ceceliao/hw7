...
class Cohort:
    def __init__(self, id, pop_size, mortality_prob):
        ...
        self._ifSurvivedBeyond5Years = []  # list of 0 and 1's to record if a patient survived beyond 5 years
    ...
    def simulate(self, n_time_steps):
        ...
        for patient in self._patients:
            ...
            if not (value is None):
                ...
                if value >= 5:
                    self._ifSurvivedBeyond5Years.append(1)
                else:
                    self._ifSurvivedBeyond5Years.append(0)
    ...
    def get_if_survived_5_years(self):
        """ :returns the list of 0 and 1's to record the 5-year survival status of patients """
        return self._ifSurvivedBeyond5Years
...
class CohortOutcomes:
    def __init__(self, simulated_cohort):
        ...
        # summary statistics on five-year survival
        self._sumStat_fiveYearSurvival = \
            Stat.SummaryStat('Five-year survival', self._simulatedCohort.get_if_survived_5_years())
    ...
    def get_prob_5_year_survival(self):
        """ returns the proportion of individuals who survived beyong 5 years """
        return self._sumStat_fiveYearSurvival.get_mean()
...
class MultiCohort:
    ...
    def __init__(self, ids, pop_sizes, mortality_probs):
        ...
        self._probFiveYearSurvivals = []  # list of prob of five year survival from each simulated cohort
    ...
    def simulate(self, n_time_steps):
        ...
        for i in range(len(self._ids)):
            ...
            # store probability of five year survival for this cohort
            self._probFiveYearSurvivals.append(output.get_prob_5_year_survival())
    ...
    def get_cohort_prob_five_year_survival(self, cohort_index):
        """ returns the five year probability of a specified cohort
        :param cohort_index: integer over [0,1, ...] corresponding to the 1st, 2nd ... simulated cohort """
        return self._probFiveYearSurvivals[cohort_index]
